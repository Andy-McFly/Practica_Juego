...
public class Vista
{
	...
	Frame vNombres = new Frame("Stiete y Media: Nueva Partida");
	...
	//DIÁLOGO Auxiliar
	Dialog dlgAux = new Dialog(vPrincipal, "Aviso", true);
